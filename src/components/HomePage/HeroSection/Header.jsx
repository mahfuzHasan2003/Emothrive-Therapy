  ...
  return (
    <div>
      <div style={{
        ...
        <p className='mt-[40px] text-[60px] text-center font-serif italic font-bold'>AI-Powered <span className='text-[#018001]'>Mental Health</span><br />
        ...
        <div className='flex justify-center'>
          <div className='w-[510px] py-3 bg-[#FFFF] rounded-[9999px] text-[#686F7D] font-bold flex gap-4 items-center mt-[30px]'>
